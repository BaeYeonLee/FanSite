  ...
  <div class="tab-box">
    <div class="tabs">
      ...
      <div class="tab" v-for="(category, idx) in categories" :key="idx">
        ...
        <div>
          <hr class="selected-tab" v-if="currentTab == idx" />
          <hr v-else />
        </div>
      </div>
    </div>
    ...
    <div class="tab-contents">
      <div class="content">
        ...
        <div v-if="currentTab == 1" class="drama-content">
          <img v-for="(img, idx) in dramaImages" :key="idx" :src="img" />
        </div>
      </div>
    </div>
    <!-- end -->
    <!-- see more 버튼 -->
    <div align="right" class="button-div">
      <button @click="move()" class="more-button">see more ></button>
    </div>
    <!-- end -->
  </div>
</template>
